...
class Chosen extends CInputWidget
{
    ...
    private function registerScripts($id)
    {
        ...
        if (defined('YII_DEBUG')) {
            $cs->registerScriptFile($this->assetsDir . '/chosen.jquery.js',CClientScript::POS_END);

            $cs->registerCssFile($this->assetsDir . '/chosen.css');
        } else {
            $cs->registerScriptFile($this->assetsDir . '/chosen.jquery.min.js',CClientScript::POS_END);
